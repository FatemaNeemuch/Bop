...
public class AlbumResultsFragment extends Fragment {

    //class constants
    public static final String TAG = "Album Results";
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        SpotifyDataManager.SearchResults(SearchFragment.getURL(), musicAdapter, musicSearchResults, premium,false, true, false);
    }
}
